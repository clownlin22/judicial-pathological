Ext.define("Rds.order.panel.PersonpriceLookGridPanel", {
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('Ext.data.Store', {
            fields: ["check_project", "check_type", "cp_id", "pc_id", "username", "username1", "hospital", "discount_type",
                "balance_type", "market_price", "cre_person", "cre_time", "state", "flag","user_id"],
            proxy: {
                type: 'jsonajax',
                actionMethods: {
                    read: 'POST'
                },
                url: 'personPrice/register/getPersonPriceByCpId.do',
                params: {
                    start: 0,
                    limit: 25,
                    cp_id: cp_id
        ...
        me.dockedItems = [{
            ...
            name: 'search',
            dock: 'top',
            items: [username, hospital,balance_type, discount_type, market_price]
        }, {
            style: {
    ...
    onUpdate: function () {
        ...
        var form = Ext.create("Rds.order.form.PersonpriceUpdateForm", {
            region: "center",
            autoScroll: true,
            grid: me,
