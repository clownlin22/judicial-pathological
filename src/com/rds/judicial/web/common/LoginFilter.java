...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (url.endsWith("login.jsp") || user != null
			...
			String string = "对不起，您的登录状态已失效，请刷新后重新登录！</br><a href="+url.split("judicial-pathological")[0]+"judicial-pathological/login.jsp>"+url.split("judicial-pathological")[0]+"judicial-pathological/login.jsp</a>";
